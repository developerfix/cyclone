  ...
  void onPressedNextStep(BuildContext context) async {
    ...
    FirebaseFirestore.instance
      ...
      if (documentSnapshot.size > 0) {
        ...
        _toastService.error(
            message: " Number already exist in the database", context: context);
        isFormValid = false;


      } else {
        print('elseeeeee::$isFormValid');
        ...
        if (isFormValid) {
          ...
          userPhonenumber = '$_dialCode${_contactEditingController.text}';
          print("this is phone numerrr::$userPhonenumber");
          //  fixme
    ...
    try {
      ...
      await _auth.verifyPhoneNumber(
          ...
          verificationFailed: (FirebaseAuthException exception) {
            print('intryyyyyyyyyyy55::$exception');
                              ...
                              Expanded(
                                child: TextFormField(
                                  ...
                                  validator: (String phone) {
                                    ...
                                    print("this is phone numbver::$phone");
