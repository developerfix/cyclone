...
class OBAuthNameStepPageState extends State<OBAuthNameStepPage> {
  ...
  void onPressedNextStep() async {
    ...
    if (isNameValid && createdUserInvite.token != null) {
      setState(() {
        ...
        print("this is phone from ::$userPhonenumber");
        ...
        _createAccountBloc.setPhone(userPhonenumber);
    ...
    return StreamBuilder(
      ...
      builder: (context, snapshot) {
        ...
        if (createAccountErrorFeedback != null) {
          ...
          print("errorrrrrrrrrrrrT::$createAccountErrorFeedback");
  ...
  Widget _buildStatusError(BuildContext context, String errorFeedback) {
    var errorTitle = localizationService.trans('auth__create_acc__submit_error_title');
    var errorDescription = errorFeedback;


    print("errorrrrrrrrrrrr:$errorTitle");
    print("errorrrrrrrrrrrrD:$errorDescription");
  ...
  Widget _moveTpnextStep(){
    Navigator.of(context).pushNamed('/intro');
    _toastService.success(message: "Account ", context: context);
    return Container();
  }
