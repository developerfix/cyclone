      ...
      child: Container(
        decoration: isAllViewed != null
            ? BoxDecoration(
                ...
                gradient:
                    isAllViewed == true ? allViewedGradient : linearGradient,
              )
            : BoxDecoration(
                color: Colors.transparent,
              ),
        padding: isAllViewed != null ? const EdgeInsets.all(3.0) : null,
        child: Container(
