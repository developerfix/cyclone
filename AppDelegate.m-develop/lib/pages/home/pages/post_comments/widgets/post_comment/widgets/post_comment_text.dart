  ...
  Widget _getActionableSmartText(bool isEdited) {
    if (isEdited) {
      return OBCollapsibleSmartText(
        size: OBTextSize.large,
        text: isorignal?widget.postComment.text:widget.postComment.translated_comment!=null?widget.postComment.translated_comment:"",
       ...
       // fixme abubakar comment tranlation handling
      return OBCollapsibleSmartText(
        size: OBTextSize.large,
        text: isorignal?widget.postComment.text:widget.postComment.translated_comment!=null?widget.postComment.translated_comment:"",
        maxlength: widget.postCommentMaxVisibleLength,
