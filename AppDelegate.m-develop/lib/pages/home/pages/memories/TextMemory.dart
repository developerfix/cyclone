 ...
 */
  ...
  void initState() {
    ...
    widget.currentFont.value = fonts[0];
    _currentFontId = 0;
  ...
  Widget build(BuildContext context) {
    ...
    */
                  ...
                  maxFontSize: widget.currentFont.value.fontSize - 5,
                  maxLines: null,
                  // maxLength: 200,
                  //maxLength: ,
                  //textDirection: ,
                  ...
                  style: TextStyle(
                    fontFamily: widget.currentFont.value.fontFamily,
                    fontSize: widget.currentFont.value.fontSize,
                    fontWeight: widget.currentFont.value.fontWeight,
                    color:
  ...
  Widget buildChangeFontIcon() {
    if (widget.isPost) return Container();
    return IconButton(
      onPressed: () {
        _currentFontId += 1;
        widget.currentFont.value = fonts[_currentFontId % fonts.length];
        setState(() {});
      },
      icon: Icon(
