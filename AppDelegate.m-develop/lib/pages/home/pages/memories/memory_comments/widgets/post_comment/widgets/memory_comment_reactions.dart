...
class MemoryCommentReactions extends StatefulWidget {
  final PostComment postComment;
  final Post post;

  MemoryCommentReactions({@required this.post, @required this.postComment});

  @override
  State<StatefulWidget> createState() {
    return MemoryCommentReactionsState();
  }
}

class MemoryCommentReactionsState extends State<MemoryCommentReactions> {
