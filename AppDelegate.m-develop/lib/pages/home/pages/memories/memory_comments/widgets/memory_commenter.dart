...
class MemoryCommenter extends StatefulWidget {
  final Story story;
  final FocusNode commentTextFieldFocusNode;
  final ValueChanged<MomentComment> onMomentCommentCreated;
  final VoidCallback onMomentCommentWillBeCreated;
  final TextEditingController textController;

  MemoryCommenter(
    this.story, {
    this.commentTextFieldFocusNode,
    this.onMomentCommentCreated,
    this.onMomentCommentWillBeCreated,
    @required this.textController,
  });

  @override
  State<StatefulWidget> createState() {
    return MemoryCommenterState();
  }
}

class MemoryCommenterState extends State<MemoryCommenter>
  ...
  void _submitForm() async {
    ...
    try {
      await (widget.onMomentCommentWillBeCreated != null
          ? widget.onMomentCommentWillBeCreated()
          : Future.value());
      ...
      MomentComment createdMomentComment =
          await _userService.uploadStoryComments(
        text: commentText,
      ...
      if (widget.onMomentCommentCreated != null)
        widget.onMomentCommentCreated(createdMomentComment);
    } catch (error) {
      _onError(error);
    } finally {
  ...
  void debugLog(String log) {
    debugPrint('MemoryCommenter:$log');
  }
