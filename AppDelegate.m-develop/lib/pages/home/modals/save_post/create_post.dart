...
import 'package:Siuu/pages/home/pages/memories/text_memory_post.dart';
...
class OBSavePostModalState extends OBContextualSearchBoxState<OBSavePostModal> {
  ...
  Widget build(BuildContext context) {
    ...
    return SafeArea(
      child: Scaffold(
        ...
        appBar: _buildNavigationBar(_localizationService),
  ...
  void addCameraDiscription({StoryType storyType}) async {
    ...
    try {
      ...
      _navigateAndDisplaySelection(context, storyType);
  ...
  _navigateAndDisplaySelection(
    ...
    final result = await Navigator.push(
        context,
        MaterialPageRoute(
          builder: (context) => FlutterCoustomCamera(storyType: storyType),
        ));
