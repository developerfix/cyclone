import 'package:Siuu/configuration.dart';
...
import 'package:Siuu/services/StoryApi.dart';
...
class OpenbookProviderState extends State<OpenbookProvider> {
  ...
  void initState() {
    ...
    authApiService.setApiURL(Configuration.API_URL);
    postsApiService.setApiURL(Configuration.API_URL);
    emojisApiService.setApiURL(Configuration.API_URL);
    userInvitesApiService.setApiURL(Configuration.API_URL);
    followsApiService.setApiURL(Configuration.API_URL);
    storyApi.setApiURL(Configuration.API_URL);
    moderationApiService.setApiURL(Configuration.API_URL);
    connectionsApiService.setApiURL(Configuration.API_URL);
    connectionsCirclesApiService.setApiURL(Configuration.API_URL);
    followsListsApiService.setApiURL(Configuration.API_URL);
    memoriesApiService.setApiURL(Configuration.API_URL);
    hashtagsApiService.setApiURL(Configuration.API_URL);
    categoriesApiService.setApiURL(Configuration.API_URL);
    notificationsApiService.setApiURL(Configuration.API_URL);
    devicesApiService.setApiURL(Configuration.API_URL);
  }
