...
class OBSmartText extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    ThemeValueParserService themeValueParserService = openbookProvider.themeValueParserService;
    ...
    return StreamBuilder(
      ...
      builder: (BuildContext context, AsyncSnapshot<OBTheme> snapshot) {
        ...
        //  fixme Abubakar post body text set on hare
        return RichText(
          overflow: overflow,
          softWrap: true,
          text: _buildSpan(
              text: text,
              style: style != null ? _textStyle : textStyle,
