...
class PostComment extends UpdatableModel<PostComment> {
  ...
  void updateFromJson(Map json) {
    ...
    } if (json.containsKey('translated_comment')) {
      translated_comment = json['translated_comment'];
    }
...
class PostCommentFactory extends UpdatableModelFactory<PostComment> {
  ...
  PostComment makeFromJson(Map json) {
    ...
    return PostComment(
        ...
        text: json['text'],
        translated_comment: json['translated_comment'],
        type: json['type'],// fixme abubakar comment type is pending
        audio: json['audio'],// fixme abubakar comment type is pending
        animation: json['animation'],// fixme abubakar comment type is pending
