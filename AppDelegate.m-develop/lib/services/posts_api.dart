...
part 'posts_api_moment_extension.dart';
...
class PostsApiService {
  ...
  static const STORY_COMMENT_PATH = 'api/story/comment/';
  static const STORY_REACTION_PATH = 'api/story/reaction/';
  static const STORY_STATUS_PATH = 'api/story/story_status/';

  static const GET_USER = 'api/auth/user/get_user';

  static const SHARE_POST = 'api/posts/share_post/';
  ...
  Future<HttpieResponse> getTimelinePosts(
    ...
    return _httpService.get(_makeApiUrl(GET_POSTS_PATH),
        // fixme abuabakr get post without regeistration
        // queryParameters: queryParams,
        appendAuthorizationToken: authenticatedRequest);
  }
  ...
  Future<HttpieResponse> getCommentsForPostWithUuid(String postUuid,
    ...
    //print("getComnent::${_makeApiUrl(path)}");
  ...
  Future<HttpieResponse> uploadStoryOnlyText({
    @required String text,
    ...
    return _httpService.putJSON(_makeApiUrl(STORY_PATH),
        body: body, appendAuthorizationToken: true);
  }

  Future<HttpieResponse> uploadStoryOnlyTextOnMap({
    @required String text,
    @required String name,
    @required String type,
    ...
    print("this is final body for textS::$body");

    return _httpService.putJSON(_makeApiUrl(STORY_PATH),
        body: body, appendAuthorizationToken: true);
  }

  Future<HttpieResponse> getUserFromId(int userId) {
    Map<String, dynamic> body = {
      'user_id': userId,
    };

    return _httpService.get(_makeApiUrl(GET_USER),
        queryParameters: body, appendAuthorizationToken: true);
  }

  Future<HttpieStreamedResponse> commentPostforFile(
      {@required String postUuid,
      @required String text,
      @required String type,
      @required File file,
  ...
  Future<HttpieStreamedResponse> uploadStory(
      {@required String text,
      @required String name,
      @required String type,
      @required String background,
    ...
    print("bodyyyy data$body");

    return _httpService.putMultiform(_makeApiUrl(STORY_PATH),
        body: body, appendAuthorizationToken: true);
  }

  Future<HttpieStreamedResponse> uploadStoryWithMap(
      {@required String text,
      @required String name,
      @required String type,
      @required String background,
    ...
    body["is_shared_on_map"] = "true";
    body['lat'] = "" + lat.toString();
    body['long'] = "" + long.toString();
    if (image != null) {
      body['image'] = image;
    }
    if (type == "text") {
  ...
  Future<HttpieResponse> getStory() {
    String path = STORY_PATH;
    return _httpService.get(_makeApiUrl(path), appendAuthorizationToken: true);
  }
  ...
  Future<HttpieResponse> sharePost({
    ...
    return _httpService.putJSON(_makeApiUrl(SHARE_POST),
        body: text_attached.isNotEmpty
            ? {
                'post_id': post_id,
                'post_type': post_type,
  ...
  String _makeApiUrl(String string) {
    //  fixme abubabakr find _makeApiurl
    print("this is api::" + '${apiURL ?? ''}$string');
