...
class NavigationService {
  ...
  Future navigateToFollowersPage(
      {@required BuildContext context, @required bool isSahre}) {
    return Navigator.push(
      context,
      OBSlideRightRoute<dynamic>(
          slidableKey: _getKeyRandomisedWithWord('followersPageRoute'),
          builder: (BuildContext context) {
            return OBFollowersPage(isSahre);
          }),
    );
  }
  ...
  Future<void> navigateToViewStory(
      {@required BuildContext context,
      @required List<Story> userStory,
