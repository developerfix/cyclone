...
class HttpieService {
  ...
  Future<HttpieResponse> post(String url,
  ...
  Future<HttpieResponse> put(String url,
    ...
    print("this is map responce::${response.statusCode}");

    return HttpieResponse(response);
  }

  Future<HttpieResponse> patch(String url,
      {Map<String, String> headers,
      body,
      Encoding encoding,
      bool appendLanguageHeader,
  ...
  Future<HttpieResponse> delete(String url,
      {Map<String, String> headers,
  ...
  Future<HttpieResponse> postJSON(String url,
  ...
  Future<HttpieResponse> putJSON(String url,
      {Map<String, String> headers = const {},
      body,
      Encoding encoding,
      bool appendLanguageHeader,
  ...
  Future<HttpieResponse> patchJSON(String url,
      {Map<String, String> headers = const {},
      body,
      Encoding encoding,
      bool appendLanguageHeader,
  ...
  Future<HttpieResponse> get(String url,
    ...
    try {
      ...
      print("myyyrespone:: " + response.body);
    } catch (error) {
      _handleRequestError(error);
    }
  ...
  Future<HttpieStreamedResponse> putMultiform(String url,
      ...
      bool appendLanguageHeader,
      bool appendAuthorizationToken}) {
    //headers = {'authorization':'9671fb8e8a5e4135bdbae5249c2cc4b3906566f4'};
  ...
  Future<HttpieStreamedResponse> _multipartRequest(String url,
    ...
    print("this is value ::$bodyKeys");

    for (final String key in bodyKeys) {
      dynamic value = body[key];

      print("this is value :key::$key");
      ...
      if (value is String || value is bool) {
        ...
        print("this is value file::$value");
