...
class StoryItem {
  ...
  static StoryItem text({
    ...
    print("this is background from api::$background");

    Color backgroundColor = Colors.black;
    bool isHaveBackground = background?.isNotEmpty == true;
    if (isHaveBackground) {
      if (background.startsWith('color:')) {
        backgroundColor =
            Color(int.parse(background.replaceFirst('color:', '')));
    ...
    print('Am i have background: $isHaveBackground');
                        ...
                        child: new Container(
                          ...
                          child: Container(
                            decoration: BoxDecoration(
                              color: isHaveBackground == true
                                  ? Colors.transparent
                                  : null,
                              gradient: isHaveBackground != true
                                  ? LinearGradient(
            ...
            child: Align(
              ...
              child: ConstrainedBox(
                ...
                child: Container(
                  key: key,
                  decoration: BoxDecoration(
                    color: isHaveBackground == true ? Colors.transparent : null,
                    gradient: isHaveBackground != true
                        ? LinearGradient(
                            begin: Alignment.topLeft,
                            end: Alignment.bottomRight,
  ...
  static Widget _buildAutoSizeText(
      String text, TextStyle style, width, height) {
    return Container(
      height: width - 50,
      width: width,
...
class StoryViewState extends State<StoryView> with TickerProviderStateMixin {
  ...
  void _play() {
    ...
    widget.controller.play("StoryViewState:1");
  }
        ...
        children: <Widget>[
          ...
          Align(
              ...
              child: GestureDetector(
                ...
                onTapCancel: () {
                  widget.controller.play("StoryViewState:2");
                },
                onTapUp: (details) {
                  // if debounce timed out (not active) then continue anim
                  if (_nextDebouncer?.isActive == false) {
                    widget.controller.play("StoryViewState:3");
                  } else {
                ...
                onVerticalDragCancel: widget.onVerticalSwipeComplete == null
                    ? null
                    : () {
                        widget.controller.play("StoryViewState:4");
                      },
                ...
                onVerticalDragEnd: widget.onVerticalSwipeComplete == null
                    ? null
                    : (details) {
                        widget.controller.play("StoryViewState:5");
