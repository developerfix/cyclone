...
import 'package:cyclone/database/download_helper.dart';
...
class DownloadedBooks extends StatefulWidget {
  @override
  DownloadedBooksState createState() => DownloadedBooksState();
}

class DownloadedBooksState extends State<DownloadedBooks> {
  bool done = true;
  var db = DownloadsDB();
