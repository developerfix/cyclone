...
import 'package:cyclone/Podcast/ui/podcast/chapter_selector.dart';
import 'package:cyclone/Podcast/ui/podcast/dot_decoration.dart';
import 'package:cyclone/Podcast/ui/podcast/playback_error_listener.dart';
import 'package:cyclone/Podcast/ui/podcast/player_position_controls.dart';
import 'package:cyclone/Podcast/ui/podcast/player_transport_controls.dart';
          ...
          return DefaultTabController(
              ...
              child: Scaffold(
                appBar: AppBar(
                  ...
                  elevation: 0.0,
                  leading: IconButton(
                    tooltip: L.of(context).minimisePlayerWindowButtonLabel,
                    icon: Icon(
      ...
      tabs: [
        Tab(
          child: Align(
            ...
            child: Text(L.of(context).episodeLabel),
          ),
        ),
        Tab(
          child: Align(
            alignment: Alignment.center,
            child: Text(L.of(context).notesLabel),
          ),
        ),
      ],
    );
    ...
    return TabBar(
      ...
      tabs: [
        Tab(
          child: Align(
            alignment: Alignment.center,
            child: Text(L.of(context).chaptersLabel),
          ),
        ),
        Tab(
          child: Align(
