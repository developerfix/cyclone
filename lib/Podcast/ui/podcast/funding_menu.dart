        ...
        : StreamBuilder<AppSettings>(
            ...
            builder: (context, snapshot) {
              return CupertinoActionSheet(
                actions: <Widget>[
                  ...List<CupertinoActionSheetAction>.generate(funding.length,
                      (index) {
    ...
    if (consent) {
      ...
      result = await showPlatformDialog<bool>(
        ...
        builder: (_) => BasicDialogAlert(
          title: Text(L.of(context).podcastFundingDialogHeader),
          content: Text(L.of(context).consentMessage),
          actions: <Widget>[
            BasicDialogAction(
              title: Text(L.of(context).goBackButtonLabel),
              onPressed: () {
                Navigator.pop(context, false);
              },
            ),
            BasicDialogAction(
              title: Text(L.of(context).continueButtonLabel),
              onPressed: () {
